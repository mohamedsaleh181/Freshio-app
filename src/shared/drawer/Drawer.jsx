...
export default function Drawer() {
  ...
  return (
    <div className="container-fluid">
      <div
        style={{ color: '#0a472e' }}
        className="row border my-3 rounded py-3"
      >
        <div className="rounded py-4">
          <h2 className="text-capitalize">
            {params.replace('/', '')} Category
          </h2>
          <hr />
        </div>
        <div>
        ...
        <div>
          <h5 className="my-4" style={{ color: '#0a472e' }}>
            Price Filter
          </h5>
          <div>
            <h6 className="my-3">
              Range : EGP {maxMinPrice[0]} - {maxMinPrice[1]}
            </h6>
            <div className="p-3">
              <Slider
                min={maxMinPrice[0]}
        ...
        <div>
          ...
          <h6 className="my-3">
            Range : Kcal {maxMinCalory[0]} - {maxMinCalory[1]}
          </h6>
          <div className="p-3">
            <Slider
              min={maxMinCalory[0]}
